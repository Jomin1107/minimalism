...
<script type="text/javascript">
	...
	function pageClick(pageNum){
		var jsQnaSearchForm = document.jsQnaSearch;
...
<main>
	<div id="bigForm">
				...
				<c:forEach var="qna" items="${qnaList}">
					<tr>
						...
						<td style="text-align: left; padding-left: 35px;">
							<img style="width: 48px; height: 64px;" src="${qna.stored_thumbnail}">
							${qna.product_number}
							${qna.product_name}
						</td>
						<td>
							<a href="/board/qnaDetail?rq_id=${qna.rq_id}">${qna.rq_title}</a>
						</td>
						<td>${qna.rq_name}</td>
						<td>
		...
		<div class="flex-container reviewWritebutton">
			<!-- <button class="writeSubmit_box" type="submit" onclick="">글쓰기</button> -->
			<a href="/board/WriteQnAForm">
		...
		<div class="flex-container searchForm">
			<div class="search">
				<form action="/board/qnaSearch" name="jsQnaSearch">	
