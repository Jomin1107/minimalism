	...
	<main>
		<div class="area">
			...
			<div class="cards_area">
				<c:forEach var="product" items="${listviewShoulder}">
					<div class="card_area">
						<a href="">
						<div class="img_area">
			...
			<div class="pageForm">
				<div class="pages">
					<c:if test="${page.startPage > page.pageBlock}">
						<a href="viewShoulder?currentPage=${page.startPage - page.pageBlock}">[이전]</a>
					</c:if>
					<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
						<a href="viewShoulder?currentPage=${i}">[${i}]</a>
					</c:forEach>
					<c:if test="${page.endPage < page.totalPage}">
						<a href="viewShoulder?currentPage=${page.startPage + page.pageBlock}">[다음]</a>
					</c:if>
				</div>
			</div>
		</div>
